...
class _UserInfromationScreenState extends State<UserInfromationScreen> {
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      CustomDropDown(itemsList: items, dropdownColor: transperentColor, onChanged: (value) {
                        selectedItem = value;
                      },)
                    ],
                  ),
  ...
  void storeData() async {
    ...
    if (image != null) {
      ...
      showSnackBar(context, "Пожалуйста загрузите фото профиля");
    }
  }
}
